...
* **Instant Feedback:** Visual cues (Green/Red) immediately indicate correct or incorrect answers.
* **Score Tracking:** Real-time score updates and a final percentage calculation.
* **Progress Bar:** Visual progress indicator at the top of the quiz.
...
Quiz_Game-repo/
│
├── index.html      # Main structure and screens (Start, Quiz, Result)
├── style.css       # All styling, variables, and animations
├── script.js       # Game logic, questions array, and event listeners
